...
class ProfileAdminInline(admin.TabularInline):
    model = Profile
    fields = ('mobile', 'mobile_confirmed', 'email', 'email_confirmed', 'nick_name', 'total_review', 'rate_avg')
    search_fields = ('user__username', 'mobile', 'email')
    readonly_fields = ('total_review', 'rate_avg', 'mobile', 'email', 'nick_name')
...
class UserAdmin(admin.ModelAdmin):
    ...
    actions = ['change_jwt', 'calculate_review_rate']
